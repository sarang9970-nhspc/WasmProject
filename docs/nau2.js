...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 6489392,
    DYNAMIC_BASE = 11732272,
    DYNAMICTOP_PTR = 6489216;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=6489232;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 6489280, 4), 6489280);
...
if (!Object.getOwnPropertyDescriptor(Module, "emscriptenWebGLGetBufferBinding__deps")) Module["emscriptenWebGLGetBufferBinding__deps"] = function() { abort("'emscriptenWebGLGetBufferBinding__deps' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "emscriptenWebGLValidateMapBufferTarget__deps")) Module["emscriptenWebGLValidateMapBufferTarget__deps"] = function() { abort("'emscriptenWebGLValidateMapBufferTarget__deps' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
...
if (!Object.getOwnPropertyDescriptor(Module, "Fetch__postset")) Module["Fetch__postset"] = function() { abort("'Fetch__postset' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
...
if (!Object.getOwnPropertyDescriptor(Module, "emscriptenWebGLGetIndexed__deps")) Module["emscriptenWebGLGetIndexed__deps"] = function() { abort("'emscriptenWebGLGetIndexed__deps' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
