...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 22160,
    DYNAMIC_BASE = 5265040,
    DYNAMICTOP_PTR = 22000;
...
var wasmBinaryFile = 'filetest.wasm';
...
var ASM_CONSTS = {
  1024: function() {var stream = FS.open('testfile.txt', 'w+'); var data = new Uint8Array(128); var str = "Hello! "; stringToUTF8Array(str, data, 0, lengthBytesUTF8(str)+1); data = data.subarray(0, lengthBytesUTF8(str)); FS.write(stream, data, 0, lengthBytesUTF8(str), 0, true); var pos = lengthBytesUTF8(str); str = '1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890'; data = new Uint8Array(100); stringToUTF8Array(str, data, 0, lengthBytesUTF8(str)+1); FS.write(stream, data, 0, lengthBytesUTF8(str)+1, pos, false); FS.close(stream);}
};




// STATICTOP = STATIC_BASE + 21136;
